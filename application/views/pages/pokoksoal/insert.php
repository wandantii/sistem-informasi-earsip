<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-lock" aria-hidden="true"></span> Pokok Soal <small> Tambah Data</small></h1>
			</div>
		</div>
	</div>
</header>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Pokok Soal - Tambah Pokok Soal</h3>
					</div>
					<div class="panel-body">
						<form action="getdata" method="post">
							...
							<div class="form-group">
								<label>Kode</label>
								<input type="text" class="form-control" name="kode_pokoksoal" required />
							</div>
							<div class="form-group">
								<label>Keterangan</label>
								<input type="text" class="form-control" name="pokoksoal" required />
							</div>
							<div class="form-group">
