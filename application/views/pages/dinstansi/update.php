				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<?php echo form_open_multipart(base_url('data_instansi/getupdate')); ?>
							...
							<div class="form-group">
								<label>Nama</label>
								<input type="text" class="form-control" name="instansi" value="<?php echo $data->instansi; ?>" required />
								<input type="hidden" name="dari_kepada2" value="<?php echo $data->instansi; ?>" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Website</label>
								<input type="text" class="form-control" name="website" value="<?php echo $data->website; ?>" required />
							</div>
							<div class="form-group">
								<label>Logo (jika logo ingin diubah)</label>
								<input type="file" name="userfile" />
								<input type="hidden" name="userfile2" value="<?php echo $data->logo; ?>" />
							</div>
							<div class="form-group">
