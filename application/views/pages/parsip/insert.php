<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Pinjam Arsip <small> Tambah Data</small></h1>
			</div>
		</div>
	</div>
</header>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Pinjam Arsip - Tambah Data Pinjam Arsip</h3>
					</div>
					<div class="panel-body">
						<form action="getdata" method="post">
							...
							<div class="form-group">
								...
								<input type="date" class="form-control" name="batas_waktu" value="<?php echo date('Y-m-d', strtotime('+7 days')); ?>" required />
							</div>
							<div class="form-group">
								<label>Petugas</label>
