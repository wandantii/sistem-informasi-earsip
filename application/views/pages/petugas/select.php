<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Petugas <small> Halaman Utama</small></h1>
			</div>
		</div>
	</div>
</header>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<?php if ($this->session->userdata('logged_in')) { ?>
							<a href="<?php base_url(); ?>petugas/insert" class="btn btn-info" role="button">
											...
											<td>
												<div class="dropdown">
													...
													<ul class="dropdown-menu">
														<li>
															<a type="button" href="<?php echo base_url('petugas/update/'.$d->id); ?>">
																Ubah Data							
															</a>	
														</li>
														<li>
															<a type="button" onclick="return confirm('Apakah anda benar-benar ingin menghapus data ini?');" href="<?php echo base_url('petugas/delete/'.$d->id); ?>">
																Hapus Data
															</a>
														</li>
													</ul>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a type="button" href="<?php echo base_url('petugas/delete/'.$d->id); ?>" class="btn btn-primary">Hapus</a>
										</div>
									</div>
								</div>
							</div>
