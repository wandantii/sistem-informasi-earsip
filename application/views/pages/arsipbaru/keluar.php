<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Arsip Baru <small> Agenda Surat Keluar</small></h1>
			</div>
		</div>
	</div>
</header>
...
<section id="breadcrumb">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <span>»</span>
            <li class="active">Agenda Surat Keluar</li>
        </ol>
    </div>
</section>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Arsip Baru - Agenda Surat Keluar</h3>
					</div>
					<div class="panel-body">
					<?php if (!$this->session->userdata('logged_in')) { ?>
						<a href="<?php base_url(); ?>ekeluar" class="btn btn-info" role="button">
