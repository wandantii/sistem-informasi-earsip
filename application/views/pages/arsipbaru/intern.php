<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Arsip Baru <small> Buku Ekspedisi Intern</small></h1>
			</div>
		</div>
	</div>
</header>
...
<section id="breadcrumb">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <span>»</span>
            <li class="active">Buku Ekspedisi Intern</li>
        </ol>
    </div>
</section>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Arsip Baru - Buku Ekspedisi Intern</h3>
					</div>
					...
					<?php if (!$this->session->userdata('logged_in')) { ?>
						...
						<div class="dropdown" style="display:inline;">
							...
							<li><a href="<?php base_url(); ?>ekstern">
											...
											<div class="dropdown">
												...
												<ul class="dropdown-menu">
													...
													<?php } else { ?>
															...
															<li>
																<a href="<?php echo base_url('arsip_baru/lembar_disposisi/'.$d->id_arsip); ?>" type="button">
																	Lembar Disposisi
																</a>
															</li>
															<li>
																<a href="<?php echo base_url('arsip_baru/eksport_disposisi/'.$d->id_arsip); ?>" type="button">
																	Export Lembar Disposisi
																</a>
															</li>
													<?php } ?>
												</ul>
