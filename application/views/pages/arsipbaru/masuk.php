<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Arsip Baru <small> Agenda Surat Masuk</small></h1>
			</div>
		</div>
	</div>
</header>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Arsip Baru - Agenda Surat Masuk</h3>
					</div>
					<div class="panel-body">
					<?php if (!$this->session->userdata('logged_in')) { ?>
						<a href="<?php base_url(); ?>emasuk" class="btn btn-info" role="button">
