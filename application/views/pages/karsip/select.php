<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Pinjam Arsip <small> Pengembalian Arsip</small></h1>
			</div>
		</div>
	</div>
</header>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Pengembalian Arsip</h3>
					</div>
					<div class="panel-body">
						<?php if ($this->session->userdata('logged_in')) { ?>
							<a href="<?php base_url(); ?>kembali_arsip/insert" class="btn btn-info" role="button">
								<span class="glyphicon glyphicon-plus"></span>
								Tambah Pengembalian Arsip
							</a>
						<?php } ?>
						<a href="<?php base_url(); ?>kembali_arsip/eksport" class="btn btn-info" role="button">
							<span class="glyphicon glyphicon-log-out"></span>
							Ekspor Excel
						</a>
						<a href="<?php base_url(); ?>pinjam_arsip" class="btn btn-info" role="button">
							<span class="glyphicon glyphicon-log-out"></span>
							Peminjaman Arsip
						</a>
						<br><br>
							...
							<table class="table table-bordered table-hover" id="manageMemberTable" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo $d->kondisi_kembali; ?></td>
										<td>
											<div class="dropdown">
												...
												<ul class="dropdown-menu">
													<li>
														<a href="<?php echo base_url('kembali_arsip/view/'.$d->id_pinjam); ?>" type="button">
															Detail Data
														</a>
													</li>
													<li>
														<a href="<?php echo base_url('kembali_arsip/cetak/'.$d->id_pinjam); ?>" type="button">
															Cetak Kartu Pinjam
														</a>
													</li>
													<?php if ($this->session->userdata('logged_in')) { ?>
														<li>
															<a type="button" href="<?php echo base_url('kembali_arsip/update/'.$d->id_pinjam); ?>">
																Ubah Data							
															</a>	
														</li>
														<li>
															<a type="button" onclick="return confirm('Apakah anda benar-benar ingin menghapus data ini?');" href="<?php echo base_url('kembali_arsip/delete/'.$d->id_pinjam); ?>">
																Hapus Data
															</a>
														</li>
													<?php } ?>
