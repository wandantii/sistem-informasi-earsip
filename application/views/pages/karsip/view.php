<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-md-10">
				<h1><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span> Pinjam Arsip <small> Detail Data Pengembalian</small></h1>
			</div>
		</div>
	</div>
</header>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
					<div class="panel-heading main-color-bg">
						<h3 class="panel-title">Pengembalian Arsip - Lihat Detail Data</h3>
					</div>
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="petugas" value="<?php echo $data->tanggal_kembali; ?>" />
						</div>
						<div class="form-group">
							<label>Kondisi Kembali</label>
							<input type="text" name="kondisi_pinjam" class="form-control" value="<?php echo $data->kondisi_kembali; ?>">
						</div>
